    ...
    'results|20': [
      {
        ...
        'source': 'nginx',
        'status': '504',
        'customerName': '天翼云专用对接帐号121211111111111111111111111111111111111111111111111111111',
        'object': '1',
...
Mock.mock(/\/api\/log_api\/list/, 'get', template)
// Mock.mock(//threat-intelligence-log//api/log_api/list/, 'get', template2)// url要写成这种形式，不能是字符串的形式，否则会报错404，且get要是小写
export default Mock
